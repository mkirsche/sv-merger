...
javac /home/mkirsche/eclipse-workspace/JasmineSim/src/*.java
...
do
	...
	do
	  ...
	  java -cp /home/mkirsche/eclipse-workspace/JasmineSim/src TandemRepeatNormalizeVcf $notraCurVcf $notraCurTsv
